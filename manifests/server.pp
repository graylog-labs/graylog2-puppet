...
class graylog2::server (
  ...
  $mongodb_hosts                                      = $graylog2::server::params::mongodb_hosts,
  ...
  $telemetry_cache_timeout                            = $graylog2::server::params::telemetry_cache_timeout,
  $telemetry_enabled                                  = $graylog2::server::params::telemetry_enabled,
  $telemetry_max_queue_size                           = $graylog2::server::params::telemetry_max_queue_size,
  $telemetry_report_interval                          = $graylog2::server::params::telemetry_report_interval,
  $telemetry_service_connect_timeout                  = $graylog2::server::params::telemetry_service_connect_timeout,
  $telemetry_service_read_timeout                     = $graylog2::server::params::telemetry_service_read_timeout,
  $telemetry_service_write_timeout                    = $graylog2::server::params::telemetry_service_write_timeout,
  $telemetry_token                                    = $graylog2::server::params::telemetry_token,
  $telemetry_url                                      = $graylog2::server::params::telemetry_url,
